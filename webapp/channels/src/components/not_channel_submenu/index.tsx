...
export const NotChannelSubMenu: React.FC<Props> = ({ channel, isArchived, isReadonly, isGuest,actions,profilesInChannel,teammateNameDisplaySetting,currentUserId,onExited}) => {
    const dispatch = useDispatch();
    const menuItems: ChannelMenu[] = [
        {
            id: "channelEditHeader",
            text: localizeMessage('channel_header.setGMConversationHeader', 'Edit Header'),
         ...
         },
        {
            ...
            action: () => {
                dispatch(openModal({
                    ...
                    dialogProps: { channel ,actions,profilesInChannel,teammateNameDisplaySetting,currentUserId,onExited}, 
                }));
            },
        }
    ];
    return (
        <Menu.ItemSubMenu
            ...
            text={localizeMessage('channel_header.groupChannelSettings', ' Settings')}
