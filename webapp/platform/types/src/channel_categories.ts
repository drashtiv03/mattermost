...
export type ChannelCategoryType = 'favorites' | 'channels' | 'direct_messages' | 'custom'| 'rename_channel'| 'edit_channel_header'| 'edit_channel_purpose'| 'channel_actions'| 'convert_to_private_channel';
